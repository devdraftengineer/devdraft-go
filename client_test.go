...
func TestUserAgentHeader(t *testing.T) {
	...
	client.V0.Health.Check(context.Background())
	if userAgent != fmt.Sprintf("Devdraft/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.V0.Health.Check(context.Background())
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.V0.Health.Check(cancelCtx)
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.V0.Health.Check(deadlineCtx)
		if err == nil {
