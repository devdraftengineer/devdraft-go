...
// RequestOption is an option for the requests made by the devdraft API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/devdraftengineer/devdraft-go#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://api.devdraft.ai/")
}
...
func WithAPIKey(value string) RequestOption {
	return requestconfig.RequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.APIKey = value
		return r.Apply(WithHeader("x-client-key", r.APIKey))
	})
}
...
func WithSecret(value string) RequestOption {
	return requestconfig.RequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.Secret = value
		return r.Apply(WithHeader("x-client-secret", r.Secret))
	})
}

// WithIdempotencyKey returns a RequestOption that sets the client setting "idempotency_key".
func WithIdempotencyKey(value string) RequestOption {
	return requestconfig.RequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.IdempotencyKey = value
		return r.Apply(WithHeader("idempotency-key", r.IdempotencyKey))
	})
}
